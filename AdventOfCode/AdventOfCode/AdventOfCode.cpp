...
const std::unordered_set<std::string> validArgs = {
    "--sampleInput", "--fullInput", "--render",   "--partA",    "--partB",
...
const std::vector<std::function<void(const std::filesystem::path &, bool)>>
    partASolvers = {Puzzle01A::PrintSolution, Puzzle02A::PrintSolution,
                    Puzzle03A::PrintSolution, Puzzle04A::PrintSolution,
                    Puzzle05A::PrintSolution, Puzzle06A::PrintSolution,
                    Puzzle07A::PrintSolution, Puzzle08A::PrintSolution,
                    Puzzle09A::PrintSolution, Puzzle10A::PrintSolution,
                    Puzzle11A::PrintSolution, Puzzle12A::PrintSolution,
                    Puzzle13A::PrintSolution, Puzzle14A::PrintSolution,
                    Puzzle15A::PrintSolution, Puzzle16A::PrintSolution,
                    Puzzle17A::PrintSolution, Puzzle18A::PrintSolution,
                    Puzzle19A::PrintSolution, Puzzle20A::PrintSolution,
                    Puzzle21A::PrintSolution, Puzzle22A::PrintSolution,
                    Puzzle23A::PrintSolution, Puzzle24A::PrintSolution,
                    Puzzle25A::PrintSolution};

const std::vector<std::function<void(const std::filesystem::path &, bool)>>
    partBSolvers = {Puzzle01B::PrintSolution, Puzzle02B::PrintSolution,
                    Puzzle03B::PrintSolution, Puzzle04B::PrintSolution,
                    Puzzle05B::PrintSolution, Puzzle06B::PrintSolution,
                    Puzzle07B::PrintSolution, Puzzle08B::PrintSolution,
                    Puzzle09B::PrintSolution, Puzzle10B::PrintSolution,
                    Puzzle11B::PrintSolution, Puzzle12B::PrintSolution,
                    Puzzle13B::PrintSolution, Puzzle14B::PrintSolution,
                    Puzzle15B::PrintSolution, Puzzle16B::PrintSolution,
                    Puzzle17B::PrintSolution, Puzzle18B::PrintSolution,
                    Puzzle19B::PrintSolution, Puzzle20B::PrintSolution,
                    Puzzle21B::PrintSolution, Puzzle22B::PrintSolution,
                    Puzzle23B::PrintSolution, Puzzle24B::PrintSolution,
                    Puzzle25B::PrintSolution};

const std::vector<std::vector<std::filesystem::path>> puzzleInputPaths = {
    {"Puzzle01.input"}, {"Puzzle02.input"}, {"Puzzle03.input"},
    {"Puzzle04.input"}, {"Puzzle05.input"}, {"Puzzle06.input"},
    {"Puzzle07.input"}, {"Puzzle08.input"}, {"Puzzle09.input"},
    {"Puzzle10.input"}, {"Puzzle11.input"}, {"Puzzle12.input"},
    {"Puzzle13.input"}, {"Puzzle14.input"}, {"Puzzle15.input"},
    {"Puzzle16.input"}, {"Puzzle17.input"}, {"Puzzle18.input"},
    {"Puzzle19.input"}, {"Puzzle20.input"}, {"Puzzle21.input"},
    {"Puzzle22.input"}, {"Puzzle23.input"}, {"Puzzle24.input"},
    {"Puzzle25.input"},
};
...
int main(int argc, char *argv[]) {
  ...
  if (args.puzzlesToRun.empty()) {
    std::cout << RED_TEXT;
    std::cout << "\nNo puzzles specified for execution. Pass desired puzzles "
  ...
  for (int puzzleId : args.puzzlesToRun) {
    for (auto i = 0; i < 2; ++i) {
      ...
      const auto solver =
          i == 0 ? partASolvers[puzzleId - 1] : partBSolvers[puzzleId - 1];
